var court_ui=(()=>{frappe.provide("court_ui.components");court_ui.components.DocketCard=class{constructor(s){Object.assign(this,s),this.make()}make(){this.card=document.createElement("div"),this.card.className="docket-card",this.render()}render(){this.card.innerHTML=`
